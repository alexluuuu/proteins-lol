...
filewriter_path = "/tmp/finetune_alexnet/ipf_vs_nonipf"
...
with tf.Session() as sess:
  ...
  #### INITIALIZE WEIGHTS ####
  # Option 1: Load the pretrained weights into the non-trainable layer
  model.load_initial_weights(sess)
  # Option 2: To continue training from one of your checkpoints
  #saver.restore(sess, "/path/to/checkpoint/model.ckpt") #/tmp/finetune_alexnet/model_epoch1.ckpt
